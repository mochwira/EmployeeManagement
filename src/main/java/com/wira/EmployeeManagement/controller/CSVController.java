...
import com.wira.EmployeeManagement.helper.ResponseMessage;
import com.wira.EmployeeManagement.model.File;
import com.wira.EmployeeManagement.service.CSVService;
...
@CrossOrigin("http://localhost:8080/file")
@Controller
...
public class CSVController {
    ...
    public ResponseEntity<List<File>> getAllTutorials() {
        try {
            List<File> tutorials = csvService.getAllTutorials();
